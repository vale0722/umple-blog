...
const Login = (props) => {
    return (
        <>
            ...
            <Container big>
                <GlobalStyle
                    background="'https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80'"/>
                <body>
                ...
                <span>
                    ...
                    <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
                        <div className="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center login">
                            <div className="absolute bg-black opacity-60 inset-0 z-0"></div>
                        </div>
