...
const AboutUs = () => {
    ...
    return (
        <div className="mt-20 md:mt-0 min-h-full mb-4">
            <Container image={city} big>
                <Title> ¿Quienes somos? </Title>
                <Subtitle>
                    Somos un grupo de desarrolladores, estudiantes de Ingenieria de sistemas en la Universidad de
                    Antioquia.
