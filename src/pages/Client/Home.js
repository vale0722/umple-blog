...
const Home = (props) => {
  ...
  return (
    <>
      ...
      <header className="flex flex-grow md:flex-row flex-col mt-20 md:mt-0 text-white w-full items-center">
        <div className="bg-opacity-50 bg-black flex-grow  flex items-center justify-center w-full container">
              ...
              <div className="items-center justify-center w-full text-center p-5 gap-5 align-middle">
                ...
                <div className="flex justify-center">
                  <div className="grid gap-4 grid-cols-1 md:px-16 w-96 text-white">
                    <Button className="bg-up-100" to="/login">
                      Inicia Sesión
                    </Button>
                    ó
                    <Button className="bg-up-50" to="/Register">
                      Registrate
                    </Button>
                  </div>
                </div>
